...
export class MdSliderField extends HTMLElement {
		...
		return /* HTML */ `
			<style>
				...
				[name="slider"]::slotted(input) {
					...
					background-image: linear-gradient(to right, var(--md-sys-color-primary) 0%, var(--md-sys-color-primary) 50%, var(--md-sys-color-surface-container-highest) 50%, var(--md-sys-color-surface-container-highest) 100%);
				}
	...
	analiza() {
		...
		if (i !== null) {
			...
			i.title = v.toString();
			i.style.background = `linear-gradient(to right, var(--md-sys-color-primary) 0%, var(--md-sys-color-primary) ${value}%, var(--md-sys-color-surface-container-highest) ${value}%, var(--md-sys-color-surface-container-highest) 100%)`;
		}
	}
}
